...
<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				<div class="login-center-img"><img src="/resource/admin/login/images/cpacha.png"></div>
				<div class="login-center-input">
                    ...
                    <img id="cpachaPic" src="${pageContext.request.contextPath}/admin/system/get_cpacha?vc=4&w=100&h=30" title="点击切换验证码" style="cursor: pointer"  onclick="changeCpacha()" width="100px" height="30px" >
				</div>
			</div>
...
<script src="/resource/admin/login/js/jquery-1.8.0.js"></script>
<script type="text/javascript">
	...
	function changeCpacha(){
	    $('#cpachaPic').attr('src','${pageContext.request.contextPath}/admin/system/get_cpacha?vc=4&w=100&h=30&d='+new Date().getTime());
    }
		document.querySelector(".login-button").onclick = function(){
				...
				$.ajax({
						url:'${pageContext.request.contextPath}/admin/system/login',
						data:{'username':username,'password':password,'cpacha':cpacha},
			            dataType:'json',
                        type:'post',
					    success:function (data) {
							if(data.type=='success'){
                                 window.parent.location="${pageContext.request.contextPath}/admin/system/homepage";
							}else {
